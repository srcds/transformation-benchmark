...
import org.deidentifier.arx.benchmark.BenchmarkTimeoutException;
...
/**
 * Extracted from the UTD toolbox to overwrite statements printing out status messages and to
 * implement a timeout
 */
public class Mondrian extends Anonymizer{
	...
	public void anonymize() throws Exception {
		...
		while(numUnprocessedEqs > 0) { //while there are more tables to be processed
			...
			if ((System.currentTimeMillis() - time) > BenchmarkSetup.TIME_LIMIT) {
