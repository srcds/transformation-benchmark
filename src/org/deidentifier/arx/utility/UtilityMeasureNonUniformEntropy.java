...
public class UtilityMeasureNonUniformEntropy<T> extends UtilityMeasureAggregatable<T>{
    ...
    public UtilityMeasureNonUniformEntropy(String[] header, String[][] input, Map<String, String[][]> hierarchies) {
        this(header, input, hierarchies, (UtilityAggregateFunction<T>)UtilityAggregateFunction.SUM);
    }
     ...
     * @param function
     */
    public UtilityMeasureNonUniformEntropy(String[] header, String[][] input, Map<String, String[][]> hierarchies, UtilityAggregateFunction<T> function) {
        super(function);
